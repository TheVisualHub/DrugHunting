...
# Code optimization, debug, introducing the switchable booleans by Gleb Novikov
# ####### ######### ########## ############ ######## ######## ######
...
optimize = True #  (True) optimize the 3D geometry of each pdb using the Universal Force Field (by default)

# get status of all activated booleans
...
# refresh the directory contained generated PDBs
...
def superb():
#def superb(use_mega=True, optimize=True): # ignore the global triggers
    get_boolean_status()
...
if __name__ == "__main__":
    ...
    print("A third strategy is imported from the hidden module. Awaiting your command...")